...
The three base checkpoints were scored with the same native BF16 direct-logit interface:

| Model | Authored balanced accuracy | Perturbation balanced accuracy | TypeSafe subset agreement |
|---|---|---:|---:|---:|
