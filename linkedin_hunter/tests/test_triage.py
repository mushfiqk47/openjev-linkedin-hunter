...
def triage_responses():
    return [
        probs(0.85, 0.15),                        # employer fit
        probs(0.1, 0.7, 0.1, 0.1),                # freshness -> this_week
        probs(0.05, 0.6, 0.1, 0.1, 0.1, 0.05),    # angles -> figma_craft
        probs(0.7, 0.1, 0.1, 0.1),                # next action -> apply_now
    ]
